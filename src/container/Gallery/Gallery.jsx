      ...
      <div className='app__gallery flex__center section__padding'>
        ...
        <div className='app__gallery-images'>
          <div className='app__gallery-images_container' ref={scrollRef}>
            {
              galleryImages.map((galleryImage, index) => (
                <div className='app__gallery-images_card flex__center' key={`gallery_image-${index + 1}`}>
                  <img src={galleryImage} alt='gallery-img' />
          ...
          <div className='app__gallery-images_arrow'>
            <BsArrowLeftShort className='images_arrow-icon' onClick={() => scroll('left')}/>
            <BsArrowRightShort className='images_arrow-icon' onClick={() => scroll('right')}/>
          </div>
        </div>
      </div>
  )
